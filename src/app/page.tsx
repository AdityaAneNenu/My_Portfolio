...
import { FaLinkedin, FaEnvelope, FaCode, FaRocket, FaBrain, FaNetworkWired, FaGithub, FaChartLine } from 'react-icons/fa'
...
function HomeContent() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      >
        <div className="glass-card px-4 md:px-6 py-3">
          <div className="flex items-center space-x-3 md:space-x-6 flex-wrap justify-center">
            <MagneticElement>
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center justify-center px-4 md:px-6 relative pt-32">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-display font-bold mb-6 leading-tight">
              ...
              <span className="block" style={{ color: '#ff783c' }}>
                <LiquidTypewriter text="Lalitaaditya Duggi" delay={5} />
              </span>
            </h1>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-xl md:text-3xl text-white/80 mb-4 font-medium">
      ...
      <section id="about" className="py-20 px-4 md:px-6 max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <GestureInteractive intensity={1.5}>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
      ...
      <section id="skills" className="py-20 px-4 md:px-6 max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto stagger-fade-in">
          <GestureInteractive>
            <motion.div
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start">
                        <div className="w-2 h-2 bg-green-400 rounded-full mr-3 mt-2 animate-pulse-slow flex-shrink-0"></div>
                        <div>
              ...
              <div className="lg:col-span-2 flex flex-col items-center lg:items-start">
                <div className="relative mb-4">
                  <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${
                    project.color === 'cyan' ? 'from-cyan-400 to-blue-600' :
                    project.color === 'purple' ? 'from-purple-400 to-pink-600' :
                    project.color === 'blue' ? 'from-blue-400 to-cyan-600' :
